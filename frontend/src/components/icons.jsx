/**
 * Small inline stroke-icon set for the sidebar nav — kept as plain SVG
 * instead of pulling in an icon package for a handful of glyphs.
 */
const base = {
  fill: "none",
  viewBox: "0 0 24 24",
...
export function CompensationIcon(props) {
  return (
    <svg {...base} {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 12h4l2.5-7 4 14L16 9h5" />
    </svg>
  );
}
